...
**→ [View the interactive predictions dashboard](https://danendral.github.io/worldcup-2026-prediction/)**

An end-to-end statistical pipeline for the [DataCamp World Cup 2026 Prediction Competition](https://www.datacamp.com/competitions/world-cup-prediction) — a single-notebook submission that forecasts every one of the 104 tournament matches (72 group + 32 knockout) before kickoff.
